...
Another alternative to RT-PCR, one that has been used since the start of the pandemic, is identifying cases through symptom-thresholding\todo{JMC: Not an official term} {[}10{]}.
...
It is worth highlighting at this point that in resource-limited settings, there is very limited provision for testing of asymptomatic cases, despite their important role in disease transmission {[}14{]} \todo{JMC: Need to highlight that we are only dealing with symptomatic patients, this felt a good place to do it}.
