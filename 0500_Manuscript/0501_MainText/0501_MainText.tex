...
2 Rising Cases & \$\textbackslash{}geq\$20\% false positive rate & False negative rate\\
3 Steady, Low-Level Cases & \$\textbackslash{}geq\$20\% false negative rate & False positive rate\\
\bottomrule
\end{tabu}
\end{table}
