...
The pattern is similar in epidemiological Scenarios 1 ("Agnostic") and 3 ("Steady, Low-Level Cases"), with the combined model class performing performing equally well or better than the other two classes (Figure \@ref(fig:scenario-plot)).
